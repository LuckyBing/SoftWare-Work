...
import com.example.order.Tool.Parser;
import com.example.order.Tool.UIHelper;
    ...
    private void initData() {
        ...
        HttpUtil.sendOkHttpRequest(url, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Toast.makeText(ProductActivity.this,"服务器连接失败",Toast.LENGTH_SHORT).show();
            }
            ...
            public void handleMessage(android.os.Message msg) {
                ...
                switch (msg.what) {
                    case 0:
                        ...
                        rightAdapter = new RightAdapter(getApplicationContext(), mProductList);
                        leftAdapter = new LeftAdapter(getApplicationContext(), mProductList);
...
//        popupWindow.setOnDismissListener();
    ...
    class RightAdapter extends BaseAdapter implements SectionIndexer {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            int salecount = UIHelper.saleCount(getApplicationContext(), mProduct.getProductId(), businessId);
            if (salecount > 0) {
    ...
    class CartAdapter extends BaseAdapter {
        ...
        private void deleteData() {
            try {
                mCartList = UIHelper.getCartList(getApplicationContext(), businessId);
                popuListView.setAdapter(new CartAdapter(this.mContext, mCartList));
                rightAdapter.notifyDataSetChanged();
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        private void updateCart(Cart mCart) {
            ...
            UIHelper.getQueryIdCart(getApplicationContext(), cart, productId,businessId);
        }
    ...
    public void onDestroy() {
        super.onDestroy();
        UIHelper.clearCart(this, businessId);
    }
}
